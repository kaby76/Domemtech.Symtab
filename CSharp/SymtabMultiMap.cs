...
namespace Symtab
{
    ...
    [System.Serializable]
    public class SymtabMultiMap<K, V> : IEnumerable<KeyValuePair<K, List<V>>>
    {
        private Dictionary<K, List<V>> the_list = null;

        public SymtabMultiMap()
            : base()
        {
        ...
        public SymtabMultiMap(int capacity)
        {
        ...
        public SymtabMultiMap(IEqualityComparer<K> comparer)
        {
        ...
        {
            IList<Tuple<K, V>> pairs = new SymtabArrayList<Tuple<K, V>>();
